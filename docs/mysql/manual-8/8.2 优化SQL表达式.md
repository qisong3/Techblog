...
在执行了哪索引的下探被跳过了以后，在对应的[INFORMATION_SCHEMA.OPTIMIZER_TRACE](https://dev.mysql.com/doc/refman/8.0/en/information-schema-optimizer-trace-table.html)表中将包含一个 skipped_due_to_force_index值的index_dives_for_range_access字段。
